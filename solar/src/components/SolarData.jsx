...
export default function SolarData({ peakData }) {
    const { peakFromWeek, peakFromMonth, peakFromYear, peakFromMonthDayAndTime, peakFromYearDayAndTime, peakFromWeekDayAndTime } = peakData
    ...
    return (
        <div className="text-right">
            <div>
                ...
                <div className="pt-1"><span className="text-yellow-500">{peakFromWeek.toFixed(0)} MW</span> last week.</div>
                <div className="supersmalltext text-slate-900">{peakFromWeekDayAndTime}-{endOfPeakWindowWeek}</div>
                <div className="pt-1"><span className="text-yellow-500">{peakFromMonth.toFixed(0)} MW</span> last month.</div>
                <div className="supersmalltext text-slate-900">{peakFromWeekDayAndTime}-{endOfPeakWindowMonth}</div>
                <div className="pt-1"><span className="text-yellow-500">{peakFromYear.toFixed(0)} MW</span> last year.</div>
                <div className="supersmalltext text-slate-900">{peakFromYearDayAndTime}-{endOfPeakWindowYear}</div>
